...
public interface IFtpSession : IAsyncDisposable
{
    ...
    Task<bool> HasEntriesAsync(string remotePath, CancellationToken cancellationToken = default);
    IAsyncEnumerable<StorageItem> ListFilesAsync(string remotePath, bool recursive, CancellationToken cancellationToken = default);
